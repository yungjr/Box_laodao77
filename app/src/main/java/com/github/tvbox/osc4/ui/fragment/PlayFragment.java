package com.github.tvbox.osc4.ui.fragment;
...
import com.github.tvbox.osc4.api.ApiConfig;
import com.github.tvbox.osc4.base.BaseLazyFragment;
import com.github.tvbox.osc4.bean.ParseBean;
import com.github.tvbox.osc4.bean.SourceBean;
import com.github.tvbox.osc4.bean.VodInfo;
import com.github.tvbox.osc4.cache.CacheManager;
import com.github.tvbox.osc4.event.RefreshEvent;
import com.github.tvbox.osc4.player.controller.VodController;
import com.github.tvbox.osc4.player.thirdparty.MXPlayer;
import com.github.tvbox.osc4.player.thirdparty.ReexPlayer;
import com.github.tvbox.osc4.player.thirdparty.Kodi;
import com.github.tvbox.osc4.util.AdBlocker;
import com.github.tvbox.osc4.util.DefaultConfig;
import com.github.tvbox.osc4.util.HawkConfig;
import com.github.tvbox.osc4.util.LOG;
import com.github.tvbox.osc4.util.MD5;
import com.github.tvbox.osc4.util.PlayerHelper;
import com.github.tvbox.osc4.util.XWalkUtils;
import com.github.tvbox.osc4.util.thunder.Thunder;
import com.github.tvbox.osc4.viewmodel.SourceViewModel;
...
public class PlayFragment extends BaseLazyFragment {
    ...
    private void initView() {
        ...
        playNetSpeed = findViewById(R.id.playNetSpeed);
    ...
    private void showNetSpeed() {
        ...
        playNetSpeed.setVisibility(View.VISIBLE);
    ...
    private Runnable mUpdateNetSpeedRun = new Runnable() {
        ...
        public void run() {
            ...
            playNetSpeed.setText(String.format("%.2fMB/s", (float) mVideoView.getTcpSpeed() / 1024.0 / 1024.0));
            SimpleDateFormat timeFormat = new SimpleDateFormat("HH:mm:ss");
            time.setText(timeFormat.format(new Date()));
            int a = (int) (mVideoView.getCurrentPosition() / 1000.0);
            int b = (int) (mVideoView.getDuration() / 1000.0);
            playnow.setText(String.format("%02d", a / 60) + ":" + String.format("%02d", a % 60) + " | " + String.format("%02d", b / 60) + ":" + String.format("%02d", b % 60));
            ...
            if (playTitle.length() > 20) {
                playTitle = playTitle.substring(0, 20);
            }
            px.setText(playTitle + "-" + name + "  [" + size[0] + "x" + size[1] + "]");
